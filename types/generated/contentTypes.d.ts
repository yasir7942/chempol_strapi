...
export interface ApiAboutUsAboutUs extends Struct.SingleTypeSchema {
  ...
  attributes: {
    aboutus: Schema.Attribute.Component<'layout.text-image', false>;
    banner: Schema.Attribute.Component<'layout.top-banner', false>;
    commitment: Schema.Attribute.Text;
    coreValue: Schema.Attribute.Component<'layout.text-image', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    facility: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    ourFocus: Schema.Attribute.Text;
    ourMission: Schema.Attribute.Component<'layout.text-image', false>;
    overValues: Schema.Attribute.Component<'layout.heading-text', true>;
    overVisson: Schema.Attribute.Component<'layout.text-image', false>;
    publishedAt: Schema.Attribute.DateTime;
    qualities: Schema.Attribute.Component<'layout.text-image', true>;
...
export interface ApiContactContact extends Struct.SingleTypeSchema {
  ...
  attributes: {
    addressBook: Schema.Attribute.Component<'layout.contact-list', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    banner: Schema.Attribute.Component<'layout.top-banner', false>;
    bodyHeading1: Schema.Attribute.String;
    bodyHeading2: Schema.Attribute.String;
    bodyText1: Schema.Attribute.Text;
    bodyText2: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiLubricantAdditivesUaeLubricantAdditivesUae
  extends Struct.SingleTypeSchema {
  collectionName: 'lubricant_additives_uaes';
  info: {
    description: '';
    displayName: 'LubricantAdditivesUae';
    pluralName: 'lubricant-additives-uaes';
    singularName: 'lubricant-additives-uae';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::lubricant-additives-uae.lubricant-additives-uae'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'seo.seo-infomation', false>;
    slug: Schema.Attribute.UID<'title'>;
    text1: Schema.Attribute.Component<'layout.heading-text', false>;
    text2: Schema.Attribute.Component<'layout.heading-text', false>;
    textimage1: Schema.Attribute.Component<'layout.text-image', false>;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    whyUs: Schema.Attribute.Component<'layout.heading-text-icon', true>;
  };
}
...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Blocks;
    featureImage: Schema.Attribute.Media<'images' | 'videos'> &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    PostDate: Schema.Attribute.Date &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'2024-05-15'>;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'seo.seo-infomation', false>;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
    title: Schema.Attribute.String &
...
export interface ApiProductCategoryProductCategory
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    middleDescription: Schema.Attribute.Blocks;
    middleTitle: Schema.Attribute.String;
    products: Schema.Attribute.Relation<'manyToMany', 'api::product.product'>;
    publishedAt: Schema.Attribute.DateTime;
    readMoreTab: Schema.Attribute.Blocks;
    seo: Schema.Attribute.Component<'seo.seo-infomation', false>;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
    title: Schema.Attribute.String &
      Schema.Attribute.Required &
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    MSDSFile: Schema.Attribute.Media<'files'>;
    ...
    productSchema: Schema.Attribute.Component<'seo.product-schema', false>;
    publishedAt: Schema.Attribute.DateTime;
    ...
    seo: Schema.Attribute.Component<'seo.seo-infomation', false>;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
    table: Schema.Attribute.Component<'layout.product-table', true>;
    TDSFile: Schema.Attribute.Media<'files'>;
    tdsPacking: Schema.Attribute.Text;
    title: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiRedirectionUrlRedirectionUrl
  extends Struct.CollectionTypeSchema {
