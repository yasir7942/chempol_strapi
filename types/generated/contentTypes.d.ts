...
export interface ApiAboutUsAboutUs extends Schema.SingleType {
  ...
  attributes: {
    ...
    coreValue: Attribute.Component<'layout.text-image'>;
    qualities: Attribute.Component<'layout.text-image', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiContactContact extends Schema.SingleType {
  ...
  attributes: {
    ...
    seo: Attribute.Component<'seo.seo-infomation'>;
    addressBook: Attribute.Component<'layout.contact-list', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiLubricantAdditivesUaeLubricantAdditivesUae
  ...
  attributes: {
    ...
    slug: Attribute.UID<
      ...
      'title'
    >;
    text1: Attribute.Component<'layout.heading-text'>;
    text2: Attribute.Component<'layout.heading-text'>;
    textimage1: Attribute.Component<'layout.text-image'>;
    whyUs: Attribute.Component<'layout.heading-text-icon', true>;
    faq: Attribute.Component<'layout.faq', true>;
    seo: Attribute.Component<'seo.seo-infomation'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    table: Attribute.Component<'layout.product-table', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
